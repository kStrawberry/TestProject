...
[ExecuteInEditMode]
public class GSWater : MonoBehaviour {
    ...
    void Update()
    {
        ...
        float Dir = mat.GetFloat("_WaterDirection");
        m_TotalTime += Time.deltaTime;
        mat.SetVector("_WaterBumpTexcoordShift", new Vector4(m_TotalTime * (float)Math.Cos(Dir), m_TotalTime * (float)Math.Sin(Dir), 0, 0));
        mat.SetVector("g_f3LightDirection", new Vector4(timeOfDay.LightDirection.x, timeOfDay.LightDirection.y, timeOfDay.LightDirection.z, 0.0f));
    }
